...
def main():
    try:
        ...
        tutorial.gripper_pub("activate")
        tutorial.gripper_pub("close")
        ...
        x,y,z = tutorial.tf_listen('id5')
        tutorial.go_to_ready_state2()
        tutorial.push(x,y,z)
        tutorial.release(x,y,z)
