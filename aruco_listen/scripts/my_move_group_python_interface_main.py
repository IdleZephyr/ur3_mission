...
class MoveGroupPythonInterface(object):
    ...
    def push(self, x, y, z):
        ...
        # self.plan_cartesian(x, y+0.075, z-0.03)
        self.plan_cartesian(x, y+0.06, z-0.04)
        self.plan_cartesian(x, y+0.2, z-0.04)
